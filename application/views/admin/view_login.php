  	...
  	<div class="login-box-body">
		...
		<?php echo form_open(base_url().'admin/login');?>
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="Email address" name="email" type="email" autocomplete="off" value="<?php if(PROJECT_MODE == 0) {echo 'admin@gmail.com';} ?>" autofocus>
			</div>
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="Password" name="password" type="password" autocomplete="off" value="<?php if(PROJECT_MODE == 0) {echo '1234';} ?>">
			</div>
			<div class="row">
