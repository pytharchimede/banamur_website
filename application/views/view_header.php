			...
			<div class="row">
				...
				<div class="col-md-9 col-sm-12 main-menu" style="display: block;">
					<div class="main-menu-item">				 	
				 		<ul class="nav-menu">
							<?php
							$menu_data = $this->Model_common->get_menu_data();
							?>
							
							<?php if($menu_data['home_status'] == 1): ?>
							<li><a href="<?php echo base_url(); ?>"><?php echo HOME; ?></a></li>
							<?php endif; ?>

							<?php if(($menu_data['about_status'] != 0)||($menu_data['gallery_status'] != 0)||($menu_data['faq_status'] != 0)): ?>
							<li class="menu-item-has-children"><a href="javascript:void();"><?php echo PAGE; ?></a>
								<ul class="sub-menu">

									<?php if($menu_data['about_status'] == 1): ?>
									<li><a href="<?php echo base_url(); ?>about"><?php echo ABOUT; ?></a></li>
									<?php endif; ?>

									<?php if($menu_data['gallery_status'] == 1): ?>
									<li><a href="<?php echo base_url(); ?>gallery"><?php echo GALLERY; ?></a></li>
									<?php endif; ?>

									<?php if($menu_data['faq_status'] == 1): ?>
